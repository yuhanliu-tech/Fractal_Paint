...
import oceanVertRaw from './ocean.vs.wgsl?raw';
import oceanFragRaw from './ocean.fs.wgsl?raw';
import oceanComputeRaw from './ocean.cs.wgsl?raw';
...
export const oceanVertSrc: string = processShaderRaw(oceanVertRaw);
export const oceanFragSrc: string = processShaderRaw(oceanFragRaw);
export const oceanComputeSrc: string = processShaderRaw(oceanComputeRaw);